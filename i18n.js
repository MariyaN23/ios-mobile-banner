export const translations = {
    de: {
        ...
        "Just {{yearlyAccess}} per year": "Nur {{yearlyAccess}} pro Jahr",
        "WEEKLY ACCESS": "WÖCHENTLICHER ZUGRIFF",
        "{{yearlyPerWeek}} <br>per week": "{{yearlyPerWeek}} <br>pro Woche",
        "{{weeklyAccess}} <br>per week": "{{weeklyAccess}} <br>pro Woche",
    ...
    en: {
        ...
        "Just {{yearlyAccess}} per year": "Just {{yearlyAccess}} per year",
        "WEEKLY ACCESS": "WEEKLY ACCESS",
        "{{yearlyPerWeek}} <br>per week": "{{yearlyPerWeek}} <br>per week",
        "{{weeklyAccess}} <br>per week": "{{weeklyAccess}} <br>per week",
    ...
    es: {
        ...
        "Just {{yearlyAccess}} per year": "Solo {{yearlyAccess}} por año",
        "WEEKLY ACCESS": "ACCESO SEMANAL",
        "{{yearlyPerWeek}} <br>per week": "{{yearlyPerWeek}} <br>por semana",
        "{{weeklyAccess}} <br>per week": "{{weeklyAccess}} <br>por semana",
    ...
    fr: {
        ...
        "Just {{yearlyAccess}} per year": "Seulement {{yearlyAccess}} par an",
        "WEEKLY ACCESS": "ACCÈS HEBDOMADAIRE",
        "{{yearlyPerWeek}} <br>per week": "{{yearlyPerWeek}} <br>par semaine",
        "{{weeklyAccess}} <br>per week": "{{weeklyAccess}} <br>par semaine",
    ...
    ja: {
        ...
        "BEST OFFER": "ベストオファー",
        "Just {{yearlyAccess}} per year": "わずか{{yearlyAccess}}/年",
        "WEEKLY ACCESS": "週ごとのアクセス",
        "{{yearlyPerWeek}} <br>per week": "{{yearlyPerWeek}}/週<br>",
        "{{weeklyAccess}} <br>per week": "{{weeklyAccess}}/週<br>",
        "Terms of Use": "利用規約",
    ...
    pt: {
        ...
        "Just {{yearlyAccess}} per year": "Apenas {{yearlyAccess}} por ano",
...
export const price = {
    ...
    JPY: {
        yearlyAccess: 6277.11,
        yearlyPerWeek: 75.34,
        weeklyAccess: 1097.20,
    }
}
